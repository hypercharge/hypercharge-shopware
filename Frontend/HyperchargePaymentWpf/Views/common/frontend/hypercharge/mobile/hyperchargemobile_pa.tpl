<div class="hypercharge" id="hyperchargemobile-purchase_on_account">
    ...
    {if !$nfxAllowedCountry}
        ...
        <ul class="errorlist">
            <li>
                {s name=NotAllowedCountryError namespace="HyperchargePaymentWpf/Views/common/frontend/hypercharge/mobile/hyperchargemobile_pa"}This payment method is not allowed for this country.{/s}
            </li>
        </ul>
    ...
    {else if !$nfxSameAddress}
        ...
        <ul class="errorlist">
            <li>
                {s name=NotSameAddressesError namespace="HyperchargePaymentWpf/Views/common/frontend/hypercharge/mobile/hyperchargemobile_pa"}For this payment method the shipping address must be the same as billing address.{/s}
            </li>
        </ul>
        <input type="hidden" id="not_allowed" value="1" validation="not_allowed">
        </p>
    {else if !$nfxHideFields}
        <p class="none">
            <label for="birthday_day">{s name=Birthday namespace="HyperchargePaymentWpf/Views/common/frontend/hypercharge/mobile/hyperchargemobile_pa"}Date of Birth*:{/s}</label>
