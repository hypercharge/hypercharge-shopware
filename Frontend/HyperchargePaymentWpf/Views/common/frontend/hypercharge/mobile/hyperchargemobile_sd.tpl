<div class="hypercharge" id="hyperchargemobile-sepa_direct_debit">
    {if !$nfxHideFields}
        <p class="none">
            <label for="bank_account_holder">{s name=BankAccountHolder namespace="HyperchargePaymentWpf/Views/common/frontend/hypercharge/mobile/hyperchargemobile_sd"}Bank Account Holder*:{/s}</label>
        ...
        <p class="none">
            <label for="iban">{s name=IBAN namespace="HyperchargePaymentWpf/Views/common/frontend/hypercharge/mobile/hyperchargemobile_sd"}IBAN*:{/s}</label>
        ...
        <p class="none">
            <label for="bic">{s name=BIC namespace="HyperchargePaymentWpf/Views/common/frontend/hypercharge/mobile/hyperchargemobile_sd"}BIC*:{/s}</label>
