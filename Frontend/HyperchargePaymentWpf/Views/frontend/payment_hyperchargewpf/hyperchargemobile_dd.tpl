<div class="hypercharge" id="hyperchargemobile-direct_debit">
    <p class="none">
        <label for="bank_account_holder">{s name=BankAccountHolder namespace="HyperchargePaymentWpf/Views/frontend/payment_hyperchargewpf/hyperchargemobile_dd"}Bank Account Holder*:{/s}</label>
    ...
    <p class="none">
        <label for="bank_account_number">{s name=BankAccountNumber namespace="HyperchargePaymentWpf/Views/frontend/payment_hyperchargewpf/hyperchargemobile_dd"}Bank Account Number*:{/s}</label>
    ...
    <p class="none">
        <label for="bank_number">{s name=BankNumber namespace="HyperchargePaymentWpf/Views/frontend/payment_hyperchargewpf/hyperchargemobile_dd"}Bank Number*:{/s}</label>
