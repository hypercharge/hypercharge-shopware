...
{block name='frontend_checkout_payment_fieldset_template' append}
    {if $payment_mean.name == "hyperchargemobile_cc" || $payment_mean.name == "hyperchargemobile_dd"}
...
{block name='frontend_checkout_confirm_payment' append}
    {if !$sRegisterFinished}
        {if $sUserData.additional.payment.name == "hyperchargemobile_cc" || $sUserData.additional.payment.name == "hyperchargemobile_dd"}
